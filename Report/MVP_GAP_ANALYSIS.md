...
> Lập ngày 2026-07-20 (audit chỉ đọc). Đối chiếu định nghĩa MVP của **chính đặc tả yêu cầu** với hiện
> trạng code đã xác minh. Tách rõ 3 lớp: **Sự thật đã xác minh · Nhận định · Chưa xác định**.

---

## 1. MVP theo định nghĩa MVP mục tiêu (không tự bịa)

đặc tả yêu cầu sản phẩm mục 1 — **Kết quả mong đợi** (trích nguyên văn):
...
| # | Chặng MVP (đặc tả yêu cầu) | Trạng thái | Bằng chứng |
|---|---|---|---|
...
**Sự thật đã xác minh:** cả **9/9 chặng của định nghĩa MVP đều có code + có file E2E phủ.**
...
## 3. Điều kiện tối thiểu để gọi là MVP (đặc tả yêu cầu) — đã đạt

**Sự thật đã xác minh:** 9/9 chặng đặc tả yêu cầu có code + E2E. Theo **định nghĩa MVP của đặc tả yêu cầu**,
...
### 4.3 Có thể hoãn sau MVP (Should — phạm vi Phase 1 cho phép)
...
### 6.3 Theo **tiêu chí đánh giá của đặc tả yêu cầu** (0.4/0.25/0.15/0.1/0.1)
...
> đúng tiêu chí đánh giá. 3 cách tính cho 3 góc nhìn: **đếm Must 86% · trọng-số-nghiệp-vụ 89% ·
> mức độ hoàn thiện ~0.80**. Chênh lệch phản ánh: **kỹ thuật lõi rất mạnh, lớp UX/i18n kéo điểm xuống.**
...
| Đủ tiêu chuẩn MVP (đặc tả yêu cầu) | ✅ luồng lõi | Đạt định nghĩa MVP |
