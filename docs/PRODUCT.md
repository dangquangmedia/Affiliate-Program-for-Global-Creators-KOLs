...
> Tài liệu định hướng sản phẩm — Phase 1 (Việt Nam + Philippines).
> Trả lời: sản phẩm là gì, ai dùng, tiền chảy thế nào, làm gì / không làm gì — và **vì sao**.
...
**Nền tảng kiếm tiền từ đâu** (Phase 1 chưa hiện thực hoá phần này): thu phí dịch
...
**Core Platform "sống" ở đâu trong mockup** (để thấy nó không bị bỏ sót):
...
Đây là quyết định lõi nhất của sản phẩm. Điểm "cấn" cốt lõi nằm ở mâu thuẫn giữa
**trả-theo-view** và **ngân sách cố định của nhãn hàng**.
...
**Điểm cấn nằm ở trục ②**: nếu pricing = "tuyến tính theo view, không trần" thì
...
**Chìa khoá dung hoà:** View được phép tham gia trục ①
...
đúng ca cần loại trừ.

**Vì sao Phase 1 chạy `CONTENT_APPROVED + FLAT`:** toàn bộ vòng đời (nộp → duyệt → ghi thu
nhập → rút) nằm TRONG hệ thống, khép kín đầu-cuối; ngân sách kiểm soát tuyệt đối.
...
**Chỗ mơ hồ đã làm rõ** (chốt trước để tránh hiểu sai):
...
**Vấn đề:** suất là tài nguyên khan hiếm có ngân sách + thời gian cố định
...
**Nguyên tắc rút ra:** *đừng xây cổng cứng trên dữ liệu mình
...
2. *Thế CPS / trả theo sale?* → Đó là affiliate thật nhất (gắn doanh thu), nhưng cần tracking
   ...
   dễ vỡ tiến độ Phase 1. Đã **model-hoá chừa đường** (trục ①=`PAID_ORDER`, ②=`%`), không
